...
The Original Code is the TSO-E Cityserver.
...
namespace TSO_E_Cityserver.Refpack
{
    ...
    public class Decompresser
    {
        ...
        public byte[] Decompress(byte[] Data)
        {
            ...
            try
            {
                //Reader.ReadBytes(5); //RefPack header.
            ...
            {
                m_Logger.Error("Decompresser.cs: Decompression failed: \n" + E.ToString());
                throw new RefPackException("Decompression failed: \n" + E.ToString());
            }
